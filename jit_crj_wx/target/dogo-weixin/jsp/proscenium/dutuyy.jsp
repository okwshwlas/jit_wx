	...
	function addDate(dd,dadd){
		...
		function addClickHandlerList(jgdwName, id, jgdwywtsxx, jgdwywdwdz,juli) {
			var riqi = $("#riqi1").val();
				...
				str+="<p>"+jgdwName+"</p>";
				str+="<p>"+jgdwywdwdz+" <img src='image/icon/addres_icon1.png' width='10' height='12' /></p>";
...
<body>
	...
	<div id="wrap" style="padding-top:110px;">
    	<header id="header" style=" position:fixed; top:0; left:0; width:100%;z-index:10;">
        	...
        	<a href="javascript:tab(0);" value='1' class="list_text"><img src="image/icon/addres_icon.png" alt="" width="12" height="15" /> <span style="vertical-align:middle;" id="text1"> 切换列表</span></a>
        ...
        <div style=" position:fixed; top:40px; left:0; width:100%; z-index:9;">
        	 <ul class="nav_box" style="z-index:auto">
             	 <li><a href="javascript:void(0);" class="default" onClick="region();" id="region_l">长春市</a>
                 	<script>
	              			function alert1(){
	              				var obj = '<div>';
...
// 	              							alert("cancel")
                 ...
                 <li>
	              	...
	              	<input  id='riqi1' type="text"  name="validUntil" onFocus="WdatePicker({readOnly:true})" onchange="change1()"  value='2016-03-20' class="Wdate easyui-validatebox" /></li>
               <!--  <input type="date" id='riqi1' placeholder="日期"  class="date_sty"  onchange="change1()"/></li>
                <!-- <li><a href="javascript:void(0);" onClick="time_box();">日期</a></li>-->
             </ul>
           	...
           	<div style="position:relative;" class="map_wrap">
             		 ...
             		 <table id='mapM'>
	              		<tr style='width:100%'>
	              			...
	              			<td width='100%'>
								<div id="allmap" style="width: 100%; height:480px; text-align: center; margin:0 auto;">
									<!-- <img src="image/images/yydd_image.jpg" alt=""  /> -->
								</div>
	              			</td>
	              		</tr>
	              	</table>
					<table id='tableM' class="bordered" style='display:none' width='60%'>
					    <thead id='table111'>
					    <tr>
        ...
        <!-- 2016-5-6 列表  -->
        <div class="list_content_box" style="display:none;"  id="lise_box">
    ...
    <!-- 选择城市弹出层 -->
    <div class="city_box" style="top:85px;display:none; position:fixed; z-index:11;" id="layer">
    	 <!-- 城市字母显示 -->
    	<div>
            <div id="wx_xzqh" class="screening_box">
             </div>
    ...
    <div class="city_box" id="layer_1" style="top:85px; display:none;">
         <!-- 城市字母显示 -->
    	<div>
             <div id="wx_xzqh_qx" class="screening_box">
             </div>
    ...
    <!-- end -->
    <!-- 时间选择层 -->
    <div class="time_box" style="display:none; z-index:10;" id="time_box">
<%--         	<a href="javascript:void(0);" class="close_icon" style="top:10px;" onClick="time_clos();"><img src="<%=basePath%>/jsp/proscenium/image/icon/down_icon.png" width="25" height="18" /></a> --%>
<!--         	<ul class="time_main"> -->
<!--            		<li> -->
<!--                 	<p>长春市出入境管理局南关区分局</p> -->
<%--                     <p>长春市光明路688号 <img src="<%=basePath%>/jsp/proscenium/image/icon/addres_icon1.png" alt="" width="10" height="12" /></p> --%>
<!--                     <p class="text_color">可办理业务：护照申请、港澳证、大陆证</p> -->
<%--                     <span class="time_main_icon"><img src="<%=basePath%>/jsp/proscenium/image/icon/time_icon1.png" width="35" height="35"  /></span> --%>
<!--                 </li>  -->
<!--                 <li> -->
<!--                 	<p><span>9:00 -10:00 (剩余 26人)</span><a href="javascript:void(0);" class="btn_appoin">预 约</a></p> -->
<%--                     <span class="time_main_icon"><img src="<%=basePath%>/jsp/proscenium/image/icon/time_icon2.png" width="32" height="32"  /></span> --%>
<!--                 </li>  -->
<!--                 <li> -->
<!--                 	<p><span>10:30 -11:30 (剩余 26人)</span><a href="javascript:void(0);" class="btn_appoin">预 约</a></p> -->
<%--                     <span class="time_main_icon"><img src="<%=basePath%>/jsp/proscenium/image/icon/time_icon1.png" width="32" height="32"  /></span> --%>
<!--                 </li>  -->
<!--                 <li> -->
<!--                 	<p><span>13:00 -14:00 (剩余 26人)</span><a href="javascript:void(0);" class="btn_appoin">预 约</a></p> -->
<%--                     <span class="time_main_icon"><img src="<%=basePath%>/jsp/proscenium/image/icon/time_icon3.png" width="32" height="32"  /></span> --%>
<!--                 </li>  -->
<!--                 <li> -->
<!--                 	<p><span>15:00 -16:00 (剩余 26人)</span><a href="javascript:void(0);" class="btn_appoin">预 约</a></p> -->
<%--                     <span class="time_main_icon"><img src="<%=basePath%>/jsp/proscenium/image/icon/time_icon2.png" width="32" height="32"  /></span> --%>
<!--                 </li>  -->
