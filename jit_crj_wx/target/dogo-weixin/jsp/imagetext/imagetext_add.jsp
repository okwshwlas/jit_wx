...
<script type="text/javascript" src="<c:url value="/jsp/imagetext/js/imagetext_add.js" />"></script>
...
<table cellpadding="0" cellspacing="0" class="table-input" border="0">
	...
	<tr>
		...
		<td><input type="text" id="title" name="title" size="65" style="width:300px;"/></td>
	</tr>
	<tr>
		...
		<td><input type="text" id="link" name="link" style="width:300px;"/>
			...
			"链接地址"和"图文详细内容"至少填写一项.即会选择填写的这一项作为链接，如果都填写优先选择"链接地址"作为链接</font></div>
		</td>
	</tr>
	<tr>
...
<table cellpadding="0" cellspacing="0" class="table-input" border="0">
	...
	<tr>
		<td colspan="5" align="center"><a href="javascript:savechild()"
			id="savelist2">保存</a> <a href="javascript:cancel()" id="cancellist2">取消</a>
		</td>
	</tr>
</table>
<div id="addOrg" style="width:500px;height:300px;">
