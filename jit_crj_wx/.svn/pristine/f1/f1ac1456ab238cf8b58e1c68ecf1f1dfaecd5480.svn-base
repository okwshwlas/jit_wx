...
<a href="javascript:;" class="on"><font color=blue>快速预约|</font></a>
<a href="javascript:dogo();" ><font color="#CCCCFF" >预约查询</font></a>
</h2>
    	</header>
	   ...
	   <p class="hit"></p>
        ...
        <section id="footer">
        	<div class="add_box" id="add_box"><a href="javascript:void(0);" onClick="appendli();"><img src="image/icon/add_btn.png" alt=""  width="50" height="50"/><span style="display:block; line-height:30px;">可点击添加一位携行人一起进行快速预约</span></a></div>
