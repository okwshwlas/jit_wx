...
public class SDKService_ServiceLocator extends org.apache.axis.client.Service implements dogo.sdkaxiswebservice.SDKService_Service {
    ...
    private java.lang.String SDKService_address = "http://182.92.222.72:6200/sdk/SDKService";
    ...
    public dogo.sdkaxiswebservice.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	dogo.sdkaxiswebservice.SDKServiceBindingStub _stub = new dogo.sdkaxiswebservice.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dogo.sdkaxiswebservice.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
            	dogo.sdkaxiswebservice.SDKServiceBindingStub _stub = new dogo.sdkaxiswebservice.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
