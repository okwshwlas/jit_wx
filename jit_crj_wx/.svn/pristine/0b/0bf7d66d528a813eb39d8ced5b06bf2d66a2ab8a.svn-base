...
<script type="text/javascript" src="<c:url value="/jsp/attention/js/imagetext.js" />"></script>
...
<table cellpadding="0" cellspacing="0" class="table-input" border="0">
	...
	<tr>
		...
		<td><input type="text" size="60" id="title" name="title" style="width:300px;"/></td>
	</tr>
	<tr>
		<th class="specalt">链接地址</th>
		<td><input type="text" id="link" name="link" style="width:300px;"/>
			<div><font color="red">"链接地址"应以http://开头，如http://www.baidu.com。
			"链接地址"和"图文详细内容"至少填写一项.即会选择填写的这一项作为链接，如果都填写优先选择"本地页面"作为链接</font></div>
		</td>
	</tr>
	<tr>
...
<!-- 		<input type="button" onclick="OpenFrame()" value="添加"/> -->
		<a href="javascript:void(0)" id="savelist1" onclick="saveparent()">保存</a>
<!-- 		<input type="button" onclick="saveparent()" value="保存"/> -->
		</td>
	</tr>
	<tr>
...
<div id="showChild" align="center"  class="easyui-dialog" closed="true" style="padding:5px;width:900px;height:400px;"  buttons="#dlg-buttons" maximizable="true" minimizable="true" collapsible="true" resizable="true">
	<iframe id="if1" src='' width="100%" height="100%" frameborder="0"></iframe>
</div>
<!-- 子图文列表中新增图文的弹窗 -->
