...
<script type="text/javascript" src="../script/aui-toast.js" ></script>
    ...
    * {
    ...
    function qjdzxx(){
    	...
    	location ="thegoods_address.jsp?sqid="+sqid;
...
<!--                    </div> -->
            ...
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                    <div class="aui-list-item-input">
                        <input type="number" id="qjxx_yb" placeholder="上门取件邮政编码">
                    </div>
                </div>
            </li>
            <li class="aui-list-item">
                <div class="aui-list-item-inner">
                    <div class="aui-list-item-input">
                        <textarea name="" type="text" id="qjxx_dz" placeholder="上门取件详细地址"></textarea>
                    </div>
