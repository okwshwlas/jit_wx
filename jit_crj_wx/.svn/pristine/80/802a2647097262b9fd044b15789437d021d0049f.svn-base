	    ...
	    Date.prototype.format = function(format) {
  	    ...
  	    $(document).ready(function(){
  	    	...
  	    	$.post(path+"/proscenium/crjlstdywinfoController/weixin/selectByYwbh.do",{"ywbh":ywbh},function(data){
  	    		...
  	    		lb += '<span class="tip_text">未通过</span>审核，请根据未通过审核原因修改补充后再次提交申请。';
  	    		lb += '</p>';
  	    		$("#form").append(lb);
  	    	})
  	  	});
    ...
    <section>
        <div class="operating_box">
            <div class="pad_top" id="form">
                ...
                <div style="position: absolute; bottom: -10px; right: -10px;"><img src="../image/tag_wtg.png" alt="" width="60" height="50"/></div>
            </div>
        </div>
    </section>
    <section>
        <div class="why_box">
            ...
            <p><img src="../image/tip_icon.png" alt="" width="20" height="20"/>
                	由于您上传的证明材料与您所填写描述不符合，导致审核未成功。
            </p>
        </div>
        <div class="supplement_box"><a href="#this" >去补充材料 <img src="../image/cl_icon.png" alt="" width="20" height="20"/></a></div>
    </section>
</div>
</body>
</html>