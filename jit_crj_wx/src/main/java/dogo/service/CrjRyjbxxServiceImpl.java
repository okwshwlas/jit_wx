...
public class CrjRyjbxxServiceImpl implements CrjRyjbxxServiceI{
	...
	public List<CrjYyxx> listWx_yuyuexiangxi_yycode(String yycode) {
		return crjYyxxMapper.listWx_yuyuexiangxi_yycode(yycode);
	}
	...
	public List<CrjYyxx> findYyxxBySfzh(String sfzh,String yysj) {
		return crjYyxxMapper.selectBySfzh(sfzh,yysj);
