...
var adrxq='<%=adrxq%>';
    ...
    <script type="text/javascript">
        var suibian =' <span class="icon_select_vi"><img src="image/select.png" alt="" width="40"  height="20" /> </span>';
            ...
            <div class="aui-card-list">
                <div class="aui-content aui-margin-b-15">
                    <ul class="aui-list aui-media-list">
                        <li class="aui-list-item aui-list-item-middle">
                            <div class="aui-media-list-item-inner">
                                <div class="aui-list-item-media" style="width: 3rem;">
                                    <img src="image/icon_hu.png" class=" aui-list-img-sm">
                                </div>
                                <div class="aui-list-item-inner icon_select" id="hzss">
                                    护照申请
                                    <p>预约申请护照请选择此项</p>
                                </div>
                            </div>
                        ...
                        <li class="aui-list-item aui-list-item-middle">
                            <div class="aui-media-list-item-inner" d="gass" >
                                <div class="aui-list-item-media" style="width: 3rem;" >
                                    <img src="image/icon_ao.png" class=" aui-list-img-sm">
                                </div>
                        ...
                        <li class="aui-list-item aui-list-item-middle">
                            <div class="aui-media-list-item-inner">
                                <div class="aui-list-item-media" style="width: 3rem;">
                                    <img src="image/icon_tai.png" class=" aui-list-img-sm">
                                </div>
                                <div class="aui-list-item-inner icon_select" id="twss">
                                    赴台证申请
                        ...
                        <li class="aui-list-item aui-list-item-middle" >
                            <div class="aui-media-list-item-inner">
                                ...
                                <div class="aui-list-item-inner icon_select"  id="zjhbf">
                                   证照换补发
