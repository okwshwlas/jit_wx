...
<script type="text/javascript" src="<%=basePath%>/jsp/proscenium/lib/layer-v2.1/layer/layer.js"></script>
	...
	<script type="text/javascript" src="<%=basePath%>/jsp/proscenium/wxlv/js/cookie.js"></script>
		...
		<script type="text/javascript" src="<%=basePath%>/jsp/proscenium/grzx/js/bdryxx.js"></script>
...
// 		var els =$('#sfzh').val();
		...
		$.ajax({
			url :"http://221.8.52.247:8445/jit_crj/crj/WxRy/WxryxxSave.do",
			data : {
				"sjhm" : sjhm,
				"openid":openid
			},
...
// 						bdyrxx(openid,sjhm);
				...
				//已经与出入境微信号绑定了 但是无身份证号码 需认证*********satrt*************
						...
						//出入境微信人员信息进行修改并查询是否有详细信息  ****end*****
								...
								//进行实名认证
								alert('进行实名认证');
								location = 'renzheng.jsp?openid='+openid;
