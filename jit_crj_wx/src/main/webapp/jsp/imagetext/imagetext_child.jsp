...
<link type="text/css" rel="stylesheet"
	href="<c:url value="/nresources/default/css/jquery.hiAlerts.css"/>"
	type="text/css" />
<script src="<c:url value="/js/jquery.alerts.js" />"
	type="text/javascript"></script>
<script type="text/javascript"
	src="<c:url value="/jsp/imagetext/js/imagetext_child.js" />"></script>
<script type="text/javascript">
var path= '<%=path%>';
</script>
</head>
